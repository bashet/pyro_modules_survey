    ...
    <table class="table table-bordered table-hove">
        ...
        if($user_history){
            foreach($user_history as $history){
                ...
                echo '<td style="text-align:centre">'.(($history->finished)?'<i class="fa fa-check"></i>': '<i class="fa fa-times"></i>').'</td>';
                echo '<td style="text-align:centre">'.(($history->submitted)?'<i class="fa fa-check"></i>': '<i class="fa fa-times"></i>').'</td>';
                echo '<td></td>';
