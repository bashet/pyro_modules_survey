<div id="questions-container">
    ...
    <form class="form-horizontal" role="form" id="frm_update_question" method="post" action="{{ url:site }}survey/update_question">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="question_title" name="question_title" value="<?=$question->title?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="matter" name="matter"><?=$question->matter?></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="question_text1" name="question_text1"><?=$question->text1?></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="question_text2" name="question_text2"><?=$question->text2?></textarea>
            </div>
        </div>
        ...
        <div id="question_options">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control option_label" name="option_1_label" value="<?=$options->option_1_label?>">
                    <textarea class="form-control" id="option_1" name="option_1"><?=$options->option_1?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control option_label" name="option_2_label" value="<?=$options->option_2_label?>">
                    <textarea class="form-control" id="option_2" name="option_2"><?=$options->option_2?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control option_label" name="option_3_label" value="<?=$options->option_3_label?>">
                    <textarea class="form-control" id="option_3" name="option_3"><?=$options->option_3?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control option_label" name="option_4_label" value="<?=$options->option_4_label?>">
                    <textarea class="form-control" id="option_4" name="option_4"><?=$options->option_4?></textarea>
                </div>
            </div>
        </div>
