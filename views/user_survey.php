    ...
    if(($total_evaluators) && $total_evaluators >= 3){
        if($questions){
            ...
            foreach($questions as $q){
                ...
                echo '<tr>';
                echo '<td><input type="radio" name="q_answer-'.$q->id.'" value="1"></td>';
                echo '<td><input type="radio" name="q_answer-'.$q->id.'" value="2"></td>';
                echo '<td><input type="radio" name="q_answer-'.$q->id.'" value="3"></td>';
                echo '<td><input type="radio" name="q_answer-'.$q->id.'" value="4"></td>';
                echo '</tr>';
                echo '<tr>';
